    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/clubs/*/bookmarks").hasAnyRole("STUDENT", "CLUB_ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/clubs/*/bookmarks").hasAnyRole("STUDENT", "CLUB_ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/users/me/bookmarks").hasAnyRole("STUDENT", "CLUB_ADMIN")
